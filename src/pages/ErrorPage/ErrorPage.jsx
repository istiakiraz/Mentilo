...
import error from "../../assets/animation/error-men.json";
    ...
    <>
      ...
      >
        <Lottie
          ...
          animationData={error}
        />
        <div className="bg-secondary p-8 lg:w-6/12 w-11/12 rounded-3xl border border-secondary">
          <h1 className="md:text-4xl  text-primary text-2xl w-11/12  mx-auto text-center font-medium">
