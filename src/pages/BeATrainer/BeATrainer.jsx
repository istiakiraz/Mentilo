...
const BeATrainer = () => {
  ...
  return (
    <div className=" w-11/12 lg:w-10/12 flex flex-col lg:flex-row justify-between items-center mx-auto p-6 bg-white  rounded-xl my-10">
      <div>
        <h2 className="text-3xl font-bold mb-6 font-title lg:text-4xl lg:font-extrabold text-primary">
          Become a Trainer
        </h2>
        <p className="mb-4 text-gray-500 pb-3 border-b-2 border-gray-100 ">
          Share your skills, inspire others, and earn doing what you love. Join
          Mentilo as a trainer and grow your impact — one session at a time.
        </p>
        <form
        ...
        >
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex flex-wrap gap-4">
              {skillOptions.map((skill) => (
                <label
                  key={skill}
                  className="flex focus:ring-primary items-center gap-2"
                >
                  <input
                    type="checkbox"
                    value={skill}
          ...
          <div className="md:col-span-2">
            ...
            />
            {errors.otherInfo && (
              <p className="text-red-500 text-sm">Other Info is required</p>
            )}
          </div>
